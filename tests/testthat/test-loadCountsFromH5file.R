...
test_that("loadCountsFromHSDS returns ExpressionSet with counts table", {
...
test_that("Samples in the result ExpressinSet are equal or subset of the starting ExpressionSet GEO accesions", {
  url <- "https://ctlab.itmo.ru/hsds/?domain=/counts"
  ess <- getGEO("GSE85653")
  es <- ess[[1]]
