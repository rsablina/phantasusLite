...
To run the package enter the code sample below. ExpressionSet from the GEO doesn't contain the expression matrix -- exprs(es) is empty. Function loadCountsFromHSDS returns an ExpressionSet with the expression matrix -- the second exprs(es) contains an expression matrix.
